...
#' 
#' @export
gen_ife_data <- function(sim_params_list) {
  ...
  id <- seq(1:n)
  dta <- cbind.data.frame(G,Y1,Y2,Y3,Y4,Y5,Y6,Y7,Z1,Z2,Z3,id)
  dta.expanded <- cbind.data.frame(G,Y1,Y2,Y3,Y4,Y5,Y6,Y7,eta,lam1,lam2,lam3,Z1,Z2,Z3,id)
